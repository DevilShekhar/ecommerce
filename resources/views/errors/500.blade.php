...
<head>
    ...
    <title>500 - Internal Server Error | ShopKart</title>
    ...
    <div class="container">
        ...
        <div class="left-content">
            ...
            <div class="action-buttons">
                <button onclick="location.reload()" class="btn btn-primary">
                    <i class="fa-solid fa-rotate-right"></i> Try Refreshing
                </button>
        ...
        <div class="right-content">
            <div class="illustration-wrapper">
                <!-- Replace src below with the actual exported image asset path for 500 page -->
                <img src="{{ asset('assets/admin/images/500.png') }}" alt="500 Illustration">
            </div>
        </div>
    </div>
