        ...
        @if(isset($wishlistProducts) && $wishlistProducts->count() > 0)
            ...
            <div class="row g-4 wishlist-products-row">
                @foreach($wishlistProducts as $wishlist)
                    ...
                    @if($product)
                        <div class="col-xl-6">
                            <div class="wishlist-product-card product-details-trigger" data-product-id="{{ $product->id }}" style="cursor: pointer;">
            ...
            <div class="row g-4">
                @foreach($recommendedProducts as $product)
                    ...
                    <div class="col-xl col-lg-3 col-md-4 col-sm-6">
                        <div class="rec-product-card product-details-trigger" data-product-id="{{ $product->id }}" style="cursor: pointer;">
