...
<section class="content">
    <div class="body_scroll">
        ...
        <div class="container-fluid">
            <form action="{{ route('admin.pages.sections.update', [$page, $section]) }}" method="POST" enctype="multipart/form-data" id="sectionForm">
                @csrf
                @method('PUT')
                ...
                <div class="row clearfix">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="section_type" id="section_type" class="form-control @error('section_type') is-invalid @enderror" required>
                                                ...
                                                <option value="contact" {{ old('section_type', $section->section_type) == 'contact' ? 'selected' : '' }}>Contact Form</option>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="sort_order" min="1" class="form-control @error('sort_order') is-invalid @enderror" value="{{ old('sort_order', $section->sort_order) }}">
                                            @error('sort_order')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sub_title" class="form-control @error('sub_title') is-invalid @enderror" placeholder="Enter Sub Title" value="{{ old('sub_title', $section->sub_title) }}">
                                            @error('sub_title')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Title</label>
                                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="Enter Section Title" value="{{ old('title', $section->title) }}">
                                            @error('title')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Content</label>
                                            <textarea name="content" rows="6" class="form-control @error('content') is-invalid @enderror" placeholder="Enter section content...">{{ old('content', $section->content) }}</textarea>
                                            @error('content')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    @if($section->image)
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <img src="{{ asset('storage/' . $section->image) }}" alt="{{ $section->title }}" style="width:180px;height:120px;object-fit:cover;border-radius:8px;border:1px solid #ddd;">
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                    ...
                    <div class="col-lg-12" id="hero_images_section" style="{{ $section->section_type === 'hero' ? 'display: block;' : 'display: none;' }}">
                        <div class="card">
                            <div class="header">
                                    ...
                                    <div id="hero_images_container">
                                        ...
                                        @if(!empty($heroImages))
                                            @foreach($heroImages as $index => $image)
                                                <div class="hero-image-item row mb-3" data-index="{{ $index }}">
                                                    <div class="col-md-8">
                                                        <img src="{{ asset('storage/' . $image) }}" alt="Hero Image" style="max-height:80px;border-radius:4px;border:1px solid #ddd;padding:4px;">
                                                        <input type="file" name="hero_images[{{ $index }}]" class="form-control mt-2" accept="image/jpeg,image/png,image/jpg,image/webp">
                                        ...
                                        @else
                                            <div class="hero-image-item row mb-3" data-index="0">
                                                <div class="col-md-10">
                                                    <input type="file" name="hero_images[0]" class="form-control" accept="image/jpeg,image/png,image/jpg,image/webp">
                    ...
                    <div class="col-lg-12" id="testimonials_section" style="{{ $section->section_type === 'testimonials' ? 'display: block;' : 'display: none;' }}">
                        <div class="card">
                            <div class="header">
                                    ...
                                    <div id="testimonials_container">
                                        ...
                                        @if(!empty($testimonials))
                                            @foreach($testimonials as $index => $testimonial)
                                                <div class="testimonial-item row mb-3" data-index="{{ $index }}">
                                                    <div class="col-md-4">
                                                        <input type="text" name="testimonials[{{ $index }}][name]" class="form-control" placeholder="Customer Name" value="{{ $testimonial['name'] ?? '' }}">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <input type="text" name="testimonials[{{ $index }}][designation]" class="form-control" placeholder="Designation" value="{{ $testimonial['designation'] ?? '' }}">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <input type="number" name="testimonials[{{ $index }}][rating]" class="form-control" placeholder="Rating (1-5)" min="1" max="5" value="{{ $testimonial['rating'] ?? '' }}">
                                                    </div>
                                                    <div class="col-md-1">
                                                    ...
                                                    <div class="col-md-12 mt-2">
                                                        <textarea name="testimonials[{{ $index }}][content]" class="form-control" rows="2" placeholder="Testimonial Content">{{ $testimonial['content'] ?? '' }}</textarea>
                                                    </div>
                                                    <div class="col-md-12 mt-2">
                                                        @if(!empty($testimonial['image']))
                                                            <div class="mb-2">
                                                                <img src="{{ asset('storage/' . $testimonial['image']) }}" alt="Testimonial Image" style="width:60px;height:60px;object-fit:cover;border-radius:8px;border:1px solid #ddd;">
                                                            </div>
                                                        @endif
                                                        <input type="file" name="testimonials[{{ $index }}][image]" class="form-control" accept="image/*">
                                                        <small class="text-muted">Leave empty to keep current image.</small>
                                                    </div>
                                                </div>
                                            @endforeach
                                        @else
                                            <div class="testimonial-item row mb-3" data-index="0">
                                                <div class="col-md-4">
                                                    <input type="text" name="testimonials[0][name]" class="form-control" placeholder="Customer Name">
                                                </div>
                                                <div class="col-md-4">
                                                    <input type="text" name="testimonials[0][designation]" class="form-control" placeholder="Designation">
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="number" name="testimonials[0][rating]" class="form-control" placeholder="Rating (1-5)" min="1" max="5">
                                                </div>
                                                <div class="col-md-1">
                                                    <button type="button" class="btn btn-danger remove-testimonial" style="width:100%;">
                                                        <i class="zmdi zmdi-close"></i>
                                                ...
                                                <div class="col-md-12 mt-2">
                                                    <textarea name="testimonials[0][content]" class="form-control" rows="2" placeholder="Testimonial Content"></textarea>
                                                </div>
                                                <div class="col-md-12 mt-2">
                                                    <input type="file" name="testimonials[0][image]" class="form-control" accept="image/*">
                                                </div>
                                            </div>
                                        @endif
                                    </div>
                    ...
                    <!-- ===================================== FAQ REPEATER ====================================== -->
                    <div class="col-lg-12" id="faq_section" style="{{ $section->section_type === 'faq' ? 'display: block;' : 'display: none;' }}">
                        <div class="card">
                            <div class="header">
                                    ...
                                    <div id="faq_container">
                                        ...
                                        @if(!empty($faqs))
                                            @foreach($faqs as $index => $faq)
                                                <div class="faq-item row mb-3" data-index="{{ $index }}">
                                                    <div class="col-md-11">
                                                        <input type="text" name="faqs[{{ $index }}][question]" class="form-control mb-2" placeholder="Enter Question" value="{{ $faq['question'] ?? '' }}">
                                                        <textarea name="faqs[{{ $index }}][answer]" class="form-control" rows="2" placeholder="Enter Answer">{{ $faq['answer'] ?? '' }}</textarea>
                                                    </div>
                                                    <div class="col-md-1">
                                        ...
                                        @else
                                            <div class="faq-item row mb-3" data-index="0">
                                                <div class="col-md-11">
                                                    <input type="text" name="faqs[0][question]" class="form-control mb-2" placeholder="Enter Question">
                                                    <textarea name="faqs[0][answer]" class="form-control" rows="2" placeholder="Enter Answer"></textarea>
                                                </div>
                                                <div class="col-md-1">
                                                    <button type="button" class="btn btn-danger remove-faq" style="width:100%;">
                                                        <i class="zmdi zmdi-close"></i>
                    ...
                    <!-- ===================================== CONTACT FORM ====================================== -->
                    <div class="col-lg-12" id="contact_section" style="{{ $section->section_type === 'contact' ? 'display: block;' : 'display: none;' }}">
                        <div class="card">
                            <div class="header">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="form_action" class="form-control" placeholder="/contact/submit" value="{{ old('form_action', $section->form_action ?? '/contact/submit') }}">
                                    ...
                                    <div id="form_fields_container">
                                        ...
                                        @if(!empty($formFields))
                                            @foreach($formFields as $index => $field)
                                                <div class="form-field-item row mb-3" data-index="{{ $index }}">
                                                    <div class="col-md-3">
                                                        <input type="text" name="form_fields[{{ $index }}][label]" class="form-control" placeholder="Field Label" value="{{ $field['label'] ?? '' }}">
                                                    </div>
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-2">
                                                        <input type="text" name="form_fields[{{ $index }}][name]" class="form-control" placeholder="Field Name" value="{{ $field['name'] ?? '' }}">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <input type="text" name="form_fields[{{ $index }}][placeholder]" class="form-control" placeholder="Placeholder" value="{{ $field['placeholder'] ?? '' }}">
                                                    </div>
                                                    <div class="col-md-1">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" name="form_fields[{{ $index }}][required]" value="1" {{ isset($field['required']) && $field['required'] ? 'checked' : '' }}>
                                                                Required
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 mt-2 form-field-options" style="{{ in_array($field['type'] ?? '', ['select', 'checkbox', 'radio']) ? 'display: block;' : 'display: none;' }}">
                                                        <input type="text" name="form_fields[{{ $index }}][options]" class="form-control" placeholder="Options (comma separated: Option 1, Option 2, Option 3)" value="{{ isset($field['options']) && is_array($field['options']) ? implode(', ', $field['options']) : '' }}">
                                        ...
                                        @else
                                            <div class="form-field-item row mb-3" data-index="0">
                                                <div class="col-md-3">
                                                    <input type="text" name="form_fields[0][label]" class="form-control" placeholder="Field Label">
                                                </div>
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="form_fields[0][name]" class="form-control" placeholder="Field Name">
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="text" name="form_fields[0][placeholder]" class="form-control" placeholder="Placeholder">
                                                </div>
                                                <div class="col-md-1">
                                                    <div class="checkbox">
                                                        <label>
                                                ...
                                                <div class="col-md-12 mt-2 form-field-options" style="display: none;">
                                                    <input type="text" name="form_fields[0][options]" class="form-control" placeholder="Options (comma separated: Option 1, Option 2, Option 3)">
                                                    <small class="text-muted">For select, checkbox, and radio fields only</small>
                                                </div>
                                            </div>
                                        @endif
                    ...
                    <!-- ===================================== FOOTER SECTION ====================================== -->
                    <div class="col-lg-12" id="footer_section" style="{{ $section->section_type === 'footer' ? 'display: block;' : 'display: none;' }}">
                        <div class="card">
                            <div class="header">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <img src="{{ asset('storage/' . $section->logo) }}" alt="Footer Logo" style="max-height:80px;border-radius:8px;border:1px solid #ddd;padding:8px;background:#fff;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="logo" class="form-control @error('logo') is-invalid @enderror" accept="image/jpeg,image/png,image/jpg,image/webp,image/svg+xml">
                                            <small class="text-muted">{{ $section->logo ? 'Leave empty to keep current logo.' : 'Upload logo for footer (Recommended: PNG or SVG)' }}</small>
                                            @error('logo')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        @if(!empty($addresses))
                                            @foreach($addresses as $index => $address)
                                                <div class="address-item row mb-3" data-index="{{ $index }}">
                                                    <div class="col-md-12">
                                                        <input type="text" name="addresses[{{ $index }}][address]" class="form-control mb-2" placeholder="Street Address" value="{{ $address['address'] ?? '' }}">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <input type="text" name="addresses[{{ $index }}][city]" class="form-control" placeholder="City" value="{{ $address['city'] ?? '' }}">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <input type="text" name="addresses[{{ $index }}][state]" class="form-control" placeholder="State/Province" value="{{ $address['state'] ?? '' }}">
                                                    </div>
                                                    <div class="col-md-2">
                                                        <input type="text" name="addresses[{{ $index }}][zip]" class="form-control" placeholder="Zip/Postal" value="{{ $address['zip'] ?? '' }}">
                                                    </div>
                                                    <div class="col-md-1">
                                                    ...
                                                    <div class="col-md-12 mt-2">
                                                        <input type="text" name="addresses[{{ $index }}][country]" class="form-control" placeholder="Country" value="{{ $address['country'] ?? '' }}">
                                                    </div>
                                                </div>
                                            @endforeach
                                        @else
                                            <div class="address-item row mb-3" data-index="0">
                                                <div class="col-md-12">
                                                    <input type="text" name="addresses[0][address]" class="form-control mb-2" placeholder="Street Address">
                                                </div>
                                                <div class="col-md-4">
                                                    <input type="text" name="addresses[0][city]" class="form-control" placeholder="City">
                                                </div>
                                                <div class="col-md-4">
                                                    <input type="text" name="addresses[0][state]" class="form-control" placeholder="State/Province">
                                                </div>
                                                <div class="col-md-2">
                                                    <input type="text" name="addresses[0][zip]" class="form-control" placeholder="Zip/Postal">
                                                </div>
                                                <div class="col-md-1">
                                                    <button type="button" class="btn btn-danger remove-address" style="width:100%;">
                                                        <i class="zmdi zmdi-close"></i>
                                                ...
                                                <div class="col-md-12 mt-2">
                                                    <input type="text" name="addresses[0][country]" class="form-control" placeholder="Country">
                                                </div>
                                            </div>
                                        @endif
                                    </div>
                    ...
                    <!-- ===================================== PRODUCTS SELECTION ====================================== -->
                    <div class="col-lg-12" id="products_section" style="{{ $section->section_type === 'products' ? 'display: block;' : 'display: none;' }}">
                        <div class="card">
                            <div class="header">
                            ...
                            <div class="body">
                                <div class="form-group">
                                    ...
                                    <select name="products[]" id="products" class="form-control @error('products') is-invalid @enderror" multiple style="min-height:180px;">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="button_text" class="form-control @error('button_text') is-invalid @enderror" placeholder="Example: Get Started" value="{{ old('button_text', $section->button_text) }}">
                                            @error('button_text')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="button_url" class="form-control @error('button_url') is-invalid @enderror" placeholder="Example: /contact" value="{{ old('button_url', $section->button_url) }}">
                                            @error('button_url')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
