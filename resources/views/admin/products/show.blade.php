                    ...
                    <div class="card">
                        ...
                        <div class="body text-center">
                            @if($product->image)
                                ...
                                <!-- Main Image -->
                                <div class="mb-3">
                                    <img id="mainProductImage" src="{{ asset($images[0]) }}" class="img-fluid rounded border p-1" style="max-height: 280px; object-fit: contain;">
                                </div>
                                <!-- Thumbnail Gallery -->
                                <div class="d-flex flex-wrap justify-content-center">
                                    @foreach($images as $imgPath)
                                        <img src="{{ asset($imgPath) }}" width="60" height="60" class="img-thumbnail m-1 thumb-image" style="cursor: pointer; object-fit: cover;" onclick="document.getElementById('mainProductImage').src='{{ asset($imgPath) }}'">
                                    @endforeach
                                </div>
                            @else
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <strong>Price</strong>
                                    <span class="text-success font-weight-bold" style="font-size: 16px;">₹{{ number_format($product->price, 2) }}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <strong>Stock</strong>
                ...
                <div class="col-lg-8 col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row">
                                <div class="col-md-6">
                                    <p class="mb-1"><strong>Created By:</strong> {{ $product->creator->name ?? 'System' }}</p>
                                    <p class="mb-0 text-muted"><small>Date: {{ $product->created_at ? $product->created_at->format('d M, Y h:i A') : 'N/A' }}</small></p>
                                </div>
                                <div class="col-md-6">
                                    <p class="mb-1"><strong>Last Updated By:</strong> {{ $product->updater->name ?? 'System' }}</p>
                                    <p class="mb-0 text-muted"><small>Date: {{ $product->updated_at ? $product->updated_at->format('d M, Y h:i A') : 'N/A' }}</small></p>
                                </div>
                            </div>
                        </div>
                    </div>
