                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sku" class="form-control" value="{{ old('sku', $product->sku) }}" placeholder="e.g. PRD-1001" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="stock" class="form-control" value="{{ old('stock', $product->stock) }}" placeholder="0" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        @if($product->image)
                                            ...
                                            @if(count($savedImages) > 0)
                                                <label class="font-weight-bold">Currently Saved Images (Click &times; to remove):</label>
                                                <div class="d-flex flex-wrap mb-3 p-2 border rounded bg-light" id="saved_images_container">
                                                    @foreach($savedImages as $imgPath)
                                                        <div class="m-1 p-1 border rounded bg-white text-center position-relative saved-img-wrapper" style="width: 85px;">
                                                            ...
                                                            <img src="{{ asset($imgPath) }}" style="width: 75px; height: 75px; object-fit: cover;" class="img-thumbnail mt-1">
                                                        </div>
                                                    @endforeach
                                                </div>
                                            @endif
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <!-- Image Count Badge -->
                                            <div class="mt-2">
                                                <span id="image_count" class="badge badge-success p-2" style="display: none; font-size: 13px;"></span>
                                            </div>

                                            <!-- Preview Container -->
                                            <div id="image_preview_container" class="flex-wrap mt-2 p-2 border rounded bg-light" style="display: none;"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <div class="form-group">
                                            ...
                                            <textarea name="variants" class="form-control" rows="2" placeholder="Enter Product Variants">{{ old('variants', $product->variants) }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="specification" class="form-control" rows="3" placeholder="Enter Product Specifications">{{ old('specification', $product->specification) }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="meta_keywords" class="form-control" rows="2" placeholder="Enter Meta Keywords">{{ old('meta_keywords', $product->meta_keywords) }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="meta_description" class="form-control" rows="3" placeholder="Enter Meta Description or Ad Copy">{{ old('meta_description', $product->meta_description) }}</textarea>
                                        </div>
                                    </div>
