    ...
    <section class="content">
        <div class="body_scroll">
            ...
            <div class="container-fluid">
                <form id="terms-conditions-create-form" action="{{ route('admin.terms-conditions.store') }}" method="POST"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="items[0][terms_conditions_category]"
                                                            ...
                                                            value="{{ old('items.0.terms_conditions_category') }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="items[0][terms_conditions_subtitle]"
                                                            ...
                                                            value="{{ old('items.0.terms_conditions_subtitle') }}"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="items[0][terms_conditions_title]"
                                                            ...
                                                            value="{{ old('items.0.terms_conditions_title') }}"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="items[0][terms_conditions_descripton]" class="summernote @error('items.0.terms_conditions_descripton') is-invalid @enderror">{{ old('items.0.terms_conditions_descripton') }}</textarea>
