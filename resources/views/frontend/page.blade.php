    ...
    <section class="hero-section-modern">
        ...
        <div class="container"
            ...
            <div class="hero-content text-center text-white">
                ...
                <span class="hero-subtitle" style="background-color:#f8efdbd3">
                ...
                <div class="hero-description">
                    <p class="section-subtitle" style="color:#fff;">
                        Explore our curated collection of artisan jewellery, each piece crafted with precision and passion.
                    </p>
                </div>
        ...
        <div class="hero-slider-dots">
            ...
            @foreach($homeSections as $index => $section)
                <span class="hero-dot" data-slide="{{ $index + 3 }}"></span>
            @endforeach
                    ...
                    <div class="banner-slider-track" id="bannerSliderTrack"
                        ...
                        @foreach($banners as $banner)
                            <div class="banner-card"
                                ...
                                <div
                                    style="position:absolute;inset:0;background:linear-gradient(to top, rgba(0,0,0,0.55), transparent);">
                                </div>
                        ...
                        @foreach($availableProducts as $product)
                            ...
                            <div class="slider-slide" style="flex:0 0 20%;min-width:200px;">
                                <div class="product-card-compact"
                                    ...
                                    <!-- Wishlist Heart Button -->
                                    <button type="button" class="wishlist-btn" data-product-id="{{ $productId }}"
                                        data-product-name="{{ addslashes($productName) }}" data-product-price="{{ $sellingPrice }}"
    ...
    <section class="why-section">
        <div class="why-container">
            <div class="why-header">
                ...
                <h2 class="section-title">The Reasons Behind Our Sparkle</h2>
            ...
            faqItems.forEach(item => {
                ...
                question.addEventListener('click', function () {
                    ...
                    faqItems.forEach(otherItem => {
                        ...
                        if (otherToggle) {
                            otherToggle.className = 'bi bi-chevron-down';
                        }
                    });
