...
@push('styles')
    <style>
        ...
        .policy-image-title span {
            color: #3b82f6;
        }

        .policy-image-description {
            font-size: 20px;
            line-height: 1.8;
        ...
        .policy-image-stats .stat-item i {
            font-size: 24px;
            color: #3b82f6;
        }

        .policy-image-text .btn-main {
            padding: 16px 45px;
            font-size: 17px;
            border-radius: 12px;
            background: #3b82f6;
        ...
        .policy-image-text .btn-main:hover {
            background: #2563eb;
